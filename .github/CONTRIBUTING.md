...
> [!NOTE]
> If you haven't tested the link you'd like to submit, especially if it's a DDL site, please open an **[Issue](https://github.com/sleepyico/fmhy/issues)** or reach out to us on **[Discord](https://iconical.dev/discord)** rather than making a Pull Request.
...
4. Find a suitable category for the link and then submit it by making a **[Pull Request](https://github.com/sleepyico/fmhy/pulls)**. 
...
> [!TIP]
> If you want to make bigger changes to the wiki, such as debloating or restructuring a page/section, please discuss those changes with us via **[Discord](https://iconical.dev/discord)** before making a **[Pull Request](https://github.com/sleepyico/fmhy/pulls)**.

You can do one of the following:

- Open an **[Issue](https://github.com/sleepyico/fmhy/issues)** or a **[Pull Request](https://github.com/sleepyico/fmhy/pulls)** and don't forget to explain why you think the site(s) in question should be removed, unstarred, and/or changed.

- Alternatively, you can reach out to us on **[Discord](https://iconical.dev/discord)** if you're unsure whether the site should be reported or if you'd like to discuss your report with more people.
...
> [!TIP]
> You can just use our [💬 Discord](https://iconical.dev/discord) to send us sites or any changes.
